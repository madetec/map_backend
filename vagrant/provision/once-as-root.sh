...
apt-get install -y php7.1-curl php7.1-cli php7.1-intl php7.1-mysqlnd php7.1-gd php7.1-fpm php7.1-mbstring php7.1-xml php7.1-zip unzip nginx nginx-extras mysql-server-5.7
...
mysql -uroot <<< "CREATE DATABASE telecom_car"
mysql -uroot <<< "CREATE DATABASE telecom_car_test"
echo "Done!"
